...
2. Run ``git clone https://github.com/qt/qt5 -b 6.10.0`` to clone Qt5 source code
...
6. After compiling, run ``nmake install`` to install Qt5 (typically in ``C:\Qt\Qt-6.10.0``)
7. Close terminal
...
4. Click "Edit..."
5. Click "New" button
6. Add in INSTALLED_QT5_PATH (typically ``C:\Qt\Qt-6.10.0``)
...
11. Navigate to the path of Qt5 (typically ``C:\Qt\Qt-6.10.0``) and click the bin directory
